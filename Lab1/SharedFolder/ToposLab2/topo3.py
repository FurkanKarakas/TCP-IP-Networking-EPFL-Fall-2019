...
def firstNetwork():
    ...
    #ipv6 
	h1.cmd('ip -6 addr add 2019::1:2/112 dev h1-eth0')
	h1.cmd('ip -6 route add default via 2019::1:1')
    ...
    #ipv6
	h2.cmd('ip -6 addr add 2019::2:2/112 dev h2-eth0')
	h2.cmd('ip -6 route add default via 2019::2:1')
    ...
    #ipv6
	h3.cmd('ip -6 addr add 2019::3:2/112 dev h3-eth0')
	h3.cmd('ip -6 route add default via 2019::3:1')
    ...
    #ipv6
	h4.cmd('ip -6 addr add 2019::4:2/112 dev h4-eth0')
	h4.cmd('ip -6 route add default via 2019::4:1')
    ...
    #ipv6
	r1.cmd('ip -6 addr add 2019::1:1/112 dev r1-eth0')
	r1.cmd('ip -6 addr add 2019::2:1/112 dev r1-eth1')
	r1.cmd('ip -6 addr add 2019::5:1/112 dev r1-eth2')
	r1.cmd('ip -6 addr add 2019::7:1/112 dev r1-eth3')
    ...
    #ipv6
	r2.cmd('ip -6 addr add 2019::3:1/112 dev r2-eth0')
	r2.cmd('ip -6 addr add 2019::5:2/112 dev r2-eth1')
	r2.cmd('ip -6 addr add 2019::6:1/112 dev r2-eth2')
    ...
    #ipv6
	r3.cmd('ip -6 addr add 2019::4:1/112 dev r3-eth0')
	r3.cmd('ip -6 addr add 2019::6:2/112 dev r3-eth1')
	r3.cmd('ip -6 addr add 2019::7:2/112 dev r3-eth2')
	...
	r2.cmd('ip route add 10.0.3.0/24 via 10.0.3.1')
    ...
    #ipv6 route
	r1.cmd('ip -6 route add 2019::3:0/112 via 2019::5:2')
	r1.cmd('ip -6 route add 2019::4:0/112 via 2019::7:2')
	r1.cmd('ip -6 route add 2019::6:0/112 via 2019::7:2')
    
	r2.cmd('ip -6 route add 2019::3:0/112 via 2019::3:1')
	r2.cmd('ip -6 route add 2019::2:0/112 via 2019::5:1')
	r2.cmd('ip -6 route add 2019::1:0/112 via 2019::5:1')
	r2.cmd('ip -6 route add 2019::4:0/112 via 2019::3:2')

	r3.cmd('ip -6 route add 2019::1:0/112 via 2019::7:1')
	r3.cmd('ip -6 route add 2019::2:0/112 via 2019::7:1')
	r3.cmd('ip -6 route add 2019::3:0/112 via 2019::6:1')
	r3.cmd('ip -6 route add 2019::5:0/112 via 2019::7:1')
