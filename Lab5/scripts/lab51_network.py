...
def run():
    ...
    info('\n** Adding Hosts\n')
    h1 = net.addHost('h1', ip='10.0.0.1/24', hostname='h1',  privateLogDir=True,
    ...
    h2 = net.addHost('h2', ip='10.0.0.2/24', hostname='h2',  privateLogDir=True,
                     privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    r1 = net.addHost('r1', ip='10.0.0.10/24', hostname='r1',  privateLogDir=True,
                     privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h3 = net.addHost('h3', ip='10.0.1.3/24', hostname='h3',  privateLogDir=True,
                     privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    #
    ...
    """
        ...
        bw = None,
 		...
 		max_queue_size = None 
        """
    link_h3r1.intf1.config(bw=3, enable_red=True,
                           enable_ecn=True, max_queue_size=1000)
    ...
    h3.cmd('ip route add default via 10.0.1.10')
    r1.cmd('ip route add 10.0.1.0/24 via 10.0.1.10')
    r1.cmd('ip route add 10.0.0.0/24 via 10.0.0.10')
