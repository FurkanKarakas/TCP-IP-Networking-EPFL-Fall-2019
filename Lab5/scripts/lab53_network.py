...
def run():
    ...
    info('\n** Adding Hosts\n')
    h1 = net.addHost('h1', ip='10.0.1.1/24', hostname='h1',  privateLogDir=True,
                     privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h2 = net.addHost('h2', ip='10.0.2.2/24', hostname='h2',  privateLogDir=True,
                     privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h3 = net.addHost('h3', ip='10.0.3.3/24', hostname='h3',  privateLogDir=True,
                     privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    r1 = net.addHost('r1', ip='10.0.1.10/24', hostname='r1',  privateLogDir=True,
                     privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    r2 = net.addHost('r2', ip='10.0.10.20/24', hostname='r2',  privateLogDir=True,
                     privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    ...
    """
        ...
        bw = None,
 		...
 		max_queue_size = None 
    """
    link_r1r2.intf1.config(bw=2, enable_red=True, enable_ecn=True)
    link_r2h3.intf1.config(bw=2, enable_red=True, enable_ecn=True)
